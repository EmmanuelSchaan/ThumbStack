...
# path for figures
pathFig = "./figures/cmb_map/planck_act_coadd_2019_03_11/f150_prelim/"
...
hp.write_map(pathIn+"healpix_f150_prelim_map_mono.fits", hMap, overwrite=True)
hp.write_map(pathIn+"healpix_f150_prelim_div_mono.fits", hHitMap, overwrite=True)
