...
# CMB map name
cmbName = "tilecpactcomptonyboss"

# Planck + ACT
pathMap = "/global/cscratch1/sd/msyriac/data/depot/tilec/v1.0.0_rc_20190919/map_v1.0.0_rc_joint_boss/" + "tilec_single_tile_boss_comptony_deprojects_cib_map_v1.0.0_rc_joint.fits"

pathIn = "./output/cmb_map/tilec_pact_cmbksz_boss/"
...
tsCmassM = ThumbStack(u, cmassMariana, pactMap, pactMask, cmbHit=None, name=name, nameLong=None, save=False, nProc=nProc)
